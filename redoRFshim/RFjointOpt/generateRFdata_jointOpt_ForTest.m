...
function [X,Y] = generateRFdata_jointOpts_ForTest(parentDir,testIdxs,trainIdxs,params)
...
testFiles       = getHeadFilesCellArr(testIdxs); 
testRecFiles    = getReconstructedFilesCellArr(testIdxs); 

trainFiles      = getHeadFilesCellArr(trainIdxs);
trainRecFiles   = getReconstructedFilesCellArr(trainIdxs);
